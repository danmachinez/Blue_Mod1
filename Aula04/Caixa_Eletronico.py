...
quantidade_Sacar  = float(input('Qual a quantidade que vc gostaria de sacar? (Valores entre R$ 10 - R$600) '))

while quantidade_Sacar < 10 or quantidade_Sacar > 600:
    quantidade_Sacar = float(input('A quantidade informada não é permitida. Favor informar um valor entre R$ 10 e R$600: '))
